...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'logic-tree.com'
  config.app_name = 'Logic_tree'
  config.mailer.from = 'Logic_tree <no-reply@logic-tree.com>'
  ...
  #
  config.app_secret = 'JAbzZAJLA2pahFEOrIoPm1ICWa5vXFKhuCI-CeYe0oS04_WS1ZtercvJKDqI8pEiCCo'
